...
namespace CurrencyExchange.Infrastructure.Data.Migrations.Domain
{
    ...
    public partial class InitialDomainCreate : Migration
    {
        ...
        {
            // NOTE: 'Currencies' table already exists (created by ApplicationDbContext migration).
            // We only create the domain-specific tables here.
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CurrencyId = table.Column<int>(type: "int", nullable: false),
                    Balance = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Do NOT drop Currencies — it is owned by ApplicationDbContext
        }
    }
}
